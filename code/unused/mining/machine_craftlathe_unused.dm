...
/obj/machinery/autolathe2/proc/build_recipes()
	...
	CRAFT_ITEMS += new/datum/craftlathe_item("PHORON","Phoron",1,1,list("","","","","","","","",""),/obj/item/stack/sheet/mineral/phoron)
	...
	CRAFT_ITEMS += new/datum/craftlathe_item("SCREEN","Screen",1,1,list("","GLASS","","GLASS","PHORON","GLASS","","GLASS",""))
